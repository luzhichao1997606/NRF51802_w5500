...
//#define rfPowerOn() 			nrf_gpio_pin_clear(RF_SPI_SDN_PIN)	//'ò?aRFD?????à-µínSDNòy??
...
extern uint32 SystemNowtime;//????????10ms
extern uint32 uip_timer;//uip???,?10ms??1.
/******************************************************************************/
/***        Type Definitions                                                ***/
/******************************************************************************/
...
/***        Exported Variables                                              ***/
/******************************************************************************/
extern volatile uint16 delayTicks;  // ??????
